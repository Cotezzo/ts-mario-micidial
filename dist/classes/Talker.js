    ...
    constructor() {
            ...
            this.connection.on("stateChange", async (_, newState) => {
                ...
                if (newState.status === voice_1.VoiceConnectionStatus.Disconnected) {
                    if (newState.reason === voice_1.VoiceConnectionDisconnectReason.WebSocketClose && newState.closeCode === 4014) {
                        ...
                        try {
                            await voice_1.entersState(this.connection, voice_1.VoiceConnectionStatus.Connecting, 5_000); // Probably moved voice channel
                        }
                        catch {
        ...
        this.speak = async () => {
            ...
            try {
                ...
                if (stream)
                    this.resource = voice_1.createAudioResource(stream, { inlineVolume: true, inputType: voice_1.StreamType.Arbitrary });
            }
            catch (e) {
                this.shiftIfEmpty();
            ...
            this.connection = voice_1.getVoiceConnection(this.voiceChannel.guildId);
        ...
        this.player = voice_1.createAudioPlayer(); // Brand new AudioPlayer
